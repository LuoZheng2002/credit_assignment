...
def _load_train_config(
    ...
    return TrainConfig(
        ...
        training_set_sort_mode=request.training_set_sort_mode,
        ...
        use_adam_state=hp.use_adam_state,
        use_lr_warmup=hp.use_lr_warmup,
        training_time=training_time,
        num_iterations_limit=request.num_iterations_limit,
        min_grad_accum_steps=hp.min_grad_accum_steps,
        max_batch_tokens=hp.max_batch_tokens,
        ...
        lora_save_mode=hp.lora_save_mode or "adapter",
        seed=hp.seed,

...
3. Extend ablation runs after the core comparisons, prioritizing TEMPO-style branching, TreeRPO-style credit, TreeRL-style branching, TreeRL-style credit, and TreeRL combined. The next two queued ablations are the Qwen2.5 no-tool TEMPO-style branching run and the TreeRPO-style credit run, both extended from 30 to 50 epochs/chunks.

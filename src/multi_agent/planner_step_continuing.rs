...
fn get_planner_step_continuing_prompt_before_assistant(session_state: &SessionState<'_>) -> String {
    assert!(matches!(
...
pub fn get_planner_prompt_after_assistant(session_state: &SessionState<'_>) -> String {
...
pub fn get_planner_step_continuing_prompts(session_state: &SessionState<'_>) -> (String, String) {

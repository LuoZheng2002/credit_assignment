...
fn get_planner_updating_plan_prompt_before_assistant(session_state: &TrajectoryState) -> String {
...
pub fn get_planner_updating_plan_prompts(session_state: &TrajectoryState) -> (String, String) {

...
pub fn get_planner_making_plan_before_assistant(session_state: &TrajectoryState) -> String {
    assert!(matches!(
...
pub fn get_planner_making_plan_prompts(session_state: &TrajectoryState) -> (String, String) {

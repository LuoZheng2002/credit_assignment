...
fn get_planner_compacting_prompt_before_assistant(session_state: &TrajectoryState) -> String {
...
pub fn get_planner_compacting_prompts(session_state: &TrajectoryState) -> (String, String) {

...
fn get_planner_deciding_next_step_prompt_before_assistant(session_state: &TrajectoryState) -> String {
    assert!(matches!(
...
pub fn get_planner_deciding_next_step_prompts(session_state: &TrajectoryState) -> (String, String) {

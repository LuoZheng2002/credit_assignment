cargo run --bin bin_orchestrator -- \
    ...
    --inference-wrapper-log-path logs/inference_wrapper_qwen34_notool_fsdp.txt \
    --training-wrapper-log-path logs/training_wrapper_qwen34_notool_fsdp.txt \
    --tui-log-path logs/qwen3-4b_notool_fsdp.bin \
    --num-gpus 4 \
    --ui true

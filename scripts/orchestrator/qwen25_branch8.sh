cargo run --bin bin_orchestrator -- \
    ...
    --inference-wrapper-log-path logs/inference_wrapper_qwen25_branch8.txt \
    --training-wrapper-log-path logs/training_wrapper_qwen25_branch8.txt \
    --tui-log-path logs/qwen2.5-7b_branch8.bin \
    --num-gpus 1 \
    --ui true

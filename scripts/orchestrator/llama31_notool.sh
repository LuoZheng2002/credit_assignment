cargo run --bin bin_orchestrator -- \
    ...
    --inference-wrapper-log-path logs/inference_wrapper_llama31_notool.txt \
    --training-wrapper-log-path logs/training_wrapper_llama31_notool.txt \
    --tui-log-path logs/llama-3.1-8b-instruct_notool.bin \
    --num-gpus 1 \
    --ui true

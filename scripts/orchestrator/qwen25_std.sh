cargo run --bin bin_orchestrator -- \
    ...
    --inference-wrapper-log-path logs/inference_wrapper_qwen25_std.txt \
    --training-wrapper-log-path logs/training_wrapper_qwen25_std.txt \
    --tui-log-path logs/qwen2.5-7b_std.bin \
    --num-gpus 1 \

cargo run --bin bin_orchestrator -- \
    ...
    --inference-wrapper-log-path logs/inference_wrapper_qwen25_grpo_notool.txt \
    --training-wrapper-log-path logs/training_wrapper_qwen25_grpo_notool.txt \
    --tui-log-path logs/qwen2.5-7b_grpo_notool.bin \
    --num-gpus 1 \
    --ui true

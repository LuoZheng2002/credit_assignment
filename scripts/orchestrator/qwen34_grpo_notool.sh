cargo run --bin bin_orchestrator -- \
    ...
    --inference-wrapper-log-path logs/inference_wrapper_qwen34_grpo_notool.txt \
    --training-wrapper-log-path logs/training_wrapper_qwen34_grpo_notool.txt \
    --tui-log-path logs/qwen3-4b_grpo_notool.bin \
    --num-gpus 1 \
    --ui true

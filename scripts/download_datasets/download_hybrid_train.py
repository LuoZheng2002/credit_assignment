"""Build `hybrid_train.jsonl` from DeepMath, MATH, and MetaMathQA."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            "Number of in-distribution training samples per dataset "
    ...
    for dataset_name in IN_DISTRIBUTION_DATASET_ORDER:
        ...
        assert_enough_rows(dataset_name, dataset.num_rows, 0, args.samples_per_dataset)

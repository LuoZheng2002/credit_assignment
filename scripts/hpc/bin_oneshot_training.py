#!/usr/bin/env python3
"""Submit a SLURM job that runs bin_oneshot_training with the given config."""
...
SPEC = SlurmJobSpec(
    ...
    slurm_script_name="oneshot_training.slurm",
    description="Submit a SLURM job that runs bin_oneshot_training with the given config.",

#!/usr/bin/env python3
"""Submit a SLURM job that runs bin_oneshot_rollout with the given config."""
...
SPEC = SlurmJobSpec(
    ...
    job_prefix="rollout_",
    slurm_script_name="oneshot_rollout.slurm",
    description="Submit a SLURM job that runs bin_oneshot_rollout with the given config.",
